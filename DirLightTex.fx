...
V2P DirLightTexVS(A2V IN)
{
	...
	OUT.diffuse  = float4(ambient + diffuse, gDiffuseMtrl.a);//modified call
...
float4 DirLightTexPS(V2P IN) : COLOR
{
	...
	return float4(IN.diffuse.rgb * IN.specular.rgb + texColor.rgb, texColor.a * IN.diffuse.a);//modified call
}	
